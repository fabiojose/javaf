...
public final class DSNPlaceString extends ValuePlace<String> {

	private ISimpleObject simple;
	
	public DSNPlaceString(final String label, final ISimpleObject simple){
		setLabel(label);
		this.simple = simple;
	}
	
	public ISimpleObject getSimple() {
		return simple;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final DSNPlaceString other = (DSNPlaceString) obj;
		if (simple == null) {
