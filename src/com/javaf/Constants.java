...
public final class Constants {
	...
	public static final class APPLICATION {
		 ...
		 * Por padrâo não existe proxy ativado, portanto essa propriedade não possui valor default.<br/>
		 * 
		 * @see UtilNet
		...
		/**
		 * Mapeamento de intercionalização, ligando qualquer chave a um texto localizado.<br/>
		 * tipo: {@link Map}
		 * 
		 */
	...
	public static final class I18N {
		...
		public static final String X_NAO_PODE_SER_OBTIDO = "{0} da implementa��o n�o pode ser obtido: {1}";
		public static final String ARGUMENTO_N_DEVE_SER_UMA_INSTANCIA = "Argumento{0} dever ser uma inst�ncia de {1}";
		public static final String OPERACAO_DESCONHECIDA = "Opera��o desconhecida: {0}";
		public static final String DEFAULT = "(Default) ";
		public static final String CONTAINER_DSN_X_NAO_POSSUI = "Container DSN {0} n�o possui �rea obrigat�ria: {1}";
		...
		public static final String DEVE_SER_UMA_IMPLEMENTACAO_DE = " deve ser uma implementa��o de ";
		...
		public static final String INVOCACAO_DO_GETTER_GEROU_EXCECAO = "Invoca��o do getter gerou exce��o.";
		...
		public static final String COLECAO_NAO_ARMAZENA = "Cole��o n�o armazena o tipo {0}: {1}";
		public static final String COLECAO_NAO_POSSUI_TIPO = "Cole��o n�o possui tipo armazenado: {0}";
		...
		public static final String PROBLEMA_GRAVACAO_AREA_FLUXO = "Problema na grava��o da �rea de entrada do fluxo: {0}";
		public static final String PROBLEMA_LEITURA_AREA_FLUXO = "Problema na leitura da �rea de sa�da do fluxo: {0}";
		public static final String PROBLEMA_EXECUCAO_FLUXO = "Problema na execu��o do fluxo: {0}";
		...
		public static final String SELECIONE_UMA_OPCAO_EM = "Selecione uma op��o em {0}";
		public static final String SELECIONAR_UMA_DAS_OPCOES = "Selecionar uma das op��es:";
		...
		public static final String IDENTIFICADOR_VALIDADOR_NAO_ENCONTRADO_NAS_CONFIGURACOES = "Idenficador do Validador n�o encontrado nas configura��es: ";
		public static final String NENHUMA_CONFIGURACAO_DE_VALIDADORES_ENCONTRADA_NO_EVENT_VALIDATOR = "Nenhuma configura��o de validadores encontrada no EventValidator.";
		public static final String NAO_FOI_ENCONTRADA_CONFIGURACAO_PARA_OPERACAO = "N�o foi encontrada configura��o para opera��o: ";
		...
		public static final String CONFIRMAR_ALTERACAO = "Confirmar altera��o?";
