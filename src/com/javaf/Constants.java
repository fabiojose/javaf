...
public final class Constants {
	...
	public static final class I18N {
		...
		public static final String CONTAINER_DSN_X_NAO_POSSUI = "Container DSN {0} não possui área obritória: {1}";
		...
		public static final String TIPO_NAO_MAPEADO_DSN = "Tipo do nó mapeado para Data Service Node: {0}";
