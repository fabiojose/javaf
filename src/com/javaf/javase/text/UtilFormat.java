...
public final class UtilFormat implements Utility {
    ...
    /**
     * Previne lançamento de <code>NullPointerException</code> e aplica a formatação persolizada
     * @param value Valor para formatação
     * @param formatter Formatação personalizada
    ...
    /**
     * Previne lançamento de <code>NullPointerException</code> e aplica formatação personalizada
     * @param date Instância para formatação
     * @param formatter Formatação personalizada
     * @return Data corrente formatada, caso a instância para formatação seja <code>null</code>
     */
     ...
     * Geralmente a formatação usada para este está no <code>FORMATTERS.TIMESTAMP_COBOL</code>
